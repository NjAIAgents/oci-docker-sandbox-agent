# instance/backend.tf — OCI Object Storage remote backend for Terraform state
#
...
#   terraform init \
#     -backend-config="address=https://objectstorage.<region>.oraclecloud.com/v1/<namespace>/ods-tf-state/instance/terraform.tfstate" \
