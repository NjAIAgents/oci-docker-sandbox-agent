...
#   - Security List (ingress TCP 22 + egress all)
#   - Public Subnet (10.0.1.0/24)
#
# These resources are stable and only created once.
# provision.sh reads the subnet_id output and passes it to the instance module.
